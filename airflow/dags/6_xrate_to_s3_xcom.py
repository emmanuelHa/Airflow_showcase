...
# Xcom shoyld be used to pass only small amount of data between tasks
# Postgres: 1Gb
# SQLite: 2Gb
# Mysql: 64Kb
# You can review the XCom detail in Airflow UI by navigating to Admin/XComs
